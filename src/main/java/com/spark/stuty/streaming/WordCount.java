...
public class WordCount {
	...
	public static void main(String[] args) throws Exception {
		...
		JavaReceiverInputDStream<String> inputDStream = jsc.socketTextStream("localhost", 9999);
		...
		JavaPairDStream<String, Integer> wordPairDStream = words.mapToPair(new PairFunction<String, String, Integer>() {
		...
		JavaPairDStream<String, Integer> wordCountDstrDStream = wordPairDStream.reduceByKey(new Function2<Integer, Integer, Integer>() {
