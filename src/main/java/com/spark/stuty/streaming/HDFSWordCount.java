...
public class HDFSWordCount {
	...
	public static void main(String[] args) {
		...
		JavaDStream<String> lineStream = jsc.textFileStream("hdfs://spark1:9000/wordcount_dir");
		// 执行wordcount操作
		JavaDStream<String> words = lineStream.flatMap(new FlatMapFunction<String, String>() {
